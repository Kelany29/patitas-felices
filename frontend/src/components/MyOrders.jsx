    ...
    const fetchOrders = async () => {
      try {
        ...
        const response = await axios.get(
          "https://patitas-felices-backend-wkn9.onrender.com/api/orders/my-orders",
          {
      ...
      {orders.length === 0 ? (
        <div className="bg-white rounded-[2.5rem] p-16 text-center border-2 border-dashed border-gray-100 shadow-sm">
          ...
          <p className="text-gray-400 font-medium max-w-xs mx-auto mb-8">
            ¡Tus mascotas te esperan! Date una vuelta por la tienda para ver las
            novedades. 🐶
          </p>
          <button
        ...
        <div className="grid gap-6">
          {orders.map((order) => (
            <div
              key={order.id}
              className="bg-white rounded-4xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300"
            >
              {/* Header de la Card */}
              <div className="p-6 bg-gray-50/50 flex flex-wrap justify-between items-center gap-4 border-b border-gray-100">
                ...
                <div className="text-right">
                  ...
                  <p className="text-2xl font-black text-[#009EE3]">
              ...
              <div className="p-8">
                <p className="text-xs font-black text-gray-300 mb-6 uppercase tracking-widest">
                  Resumen del pedido
                </p>
                  ...
                  {order.items.map((item, index) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <p className="text-gray-600 font-bold group-hover:text-gray-800 transition-colors">
                          {item.name}
                        </p>
                      </div>
                      <p className="font-bold text-gray-400 group-hover:text-[#009EE3] transition-colors">
